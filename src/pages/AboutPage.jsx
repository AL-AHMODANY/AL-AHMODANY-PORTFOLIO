    ...
    <div className="pt-28">
      <section className="section-padding max-w-7xl mx-auto">
        ...
        >
          ...
          <h1 className="font-display font-extrabold text-4xl sm:text-5xl md:text-6xl lg:text-7xl mt-4 mb-6 leading-tight px-4">
            Building interfaces with<br className="hidden sm:block" /><span className="text-gradient">care and intent</span>
          </h1>
          <p className="text-[var(--muted)] text-lg sm:text-xl max-w-3xl mx-auto leading-relaxed px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 mb-16 sm:mb-20 lg:mb-24">
          <div className="space-y-6 px-4 lg:px-0">
            ...
            >
              <h2 className="font-display font-bold text-xl sm:text-2xl mb-5 text-gradient">My Story</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {facts.map((fact, index) => (
                <motion.div
                  ...
                  className="card-glass rounded-xl p-4 sm:p-5 group hover:border-accent/30 transition-all duration-300"
                >
                  <fact.icon size={18} className="text-accent mb-3 group-hover:scale-110 transition-transform" />
          ...
          <motion.div 
            ...
            className="card-glass rounded-2xl sm:rounded-3xl p-6 sm:p-8 h-full relative overflow-hidden mx-4 lg:mx-0"
          >
            ...
            <div className="relative z-10">
              ...
              <div className="text-center mb-6 sm:mb-8">
                <h2 className="font-display font-bold text-xl sm:text-2xl">AL-AHMODANY</h2>
                <p className="text-accent font-mono text-sm mt-1">Frontend Developer</p>
              </div>

              <div className="space-y-2 mb-6 sm:mb-8">
                <p className="font-display font-semibold text-sm text-[var(--muted)] mb-3 sm:mb-4">What matters in my work</p>
                {values.map((value, index) => (
                  <div key={value.text} className="flex items-center gap-3 group">
                    ...
                    <span className="text-sm font-body leading-relaxed">{value.text}</span>
                  </div>
                ))}
              </div>
              ...
              <div className="pt-4 sm:pt-6 border-t border-[var(--border)]">
                ...
                <div className="flex gap-2 flex-wrap">
                  <span className="tag text-xs">Arabic (Native)</span>
                  <span className="tag text-xs">English (Fluent)</span>
                </div>
              </div>

              <div className="mt-4 sm:mt-6 p-3 sm:p-4 rounded-xl bg-accent/5 border border-accent/20 flex items-center gap-3">
      ...
      <section className="section-padding bg-[var(--card)] border-y border-[var(--border)]">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12 sm:mb-14">
            ...
            <p className="text-[var(--muted)] text-base sm:text-lg mt-4 max-w-2xl mx-auto px-4">
          ...
          <div className="relative">
            <div className="absolute left-6 sm:left-8 top-0 bottom-0 w-px bg-gradient-to-b from-accent via-accent/50 to-transparent"></div>
            ...
            {timeline.map((item, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="relative flex gap-6 sm:gap-8 mb-10 sm:mb-12"
              >
                <div className="relative z-10 w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl card-glass border border-accent/30 flex flex-col items-center justify-center flex-shrink-0 shadow-lg">
                  <span className="font-mono text-xs sm:text-sm font-bold text-accent">{item.year}</span>
                </div>
                <div className="card-glass rounded-xl sm:rounded-2xl p-4 sm:p-6 flex-1 hover:border-accent/30 transition-all duration-300 group min-w-0">
                  <div className="flex items-start justify-between mb-2 gap-2 sm:gap-4">
                    <h3 className="font-display font-bold text-base sm:text-lg group-hover:text-accent transition-colors min-w-0 flex-1">{item.title}</h3>
                    <span className="tag text-xs whitespace-nowrap flex-shrink-0">{item.type}</span>
                  </div>
                  <p className="text-accent font-mono text-xs sm:text-sm mb-3 break-words">{item.company}</p>
        ...
        <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
          {techSkills.map((skill, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="card-glass rounded-xl sm:rounded-2xl p-4 sm:p-5 text-center hover:border-accent/30 hover:-translate-y-1 transition-all duration-300 group cursor-default"
            >
              <span className="text-2xl sm:text-3xl mb-2 sm:mb-3 block group-hover:scale-110 transition-transform duration-300">{skill.icon}</span>
